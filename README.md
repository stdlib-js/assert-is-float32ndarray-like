...
```javascript
import isFloat32ndarrayLike from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-float32ndarray-like@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-float32ndarray-like/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-is-float32ndarray-like/actions/workflows/test.yml?query=branch:v0.2.2
